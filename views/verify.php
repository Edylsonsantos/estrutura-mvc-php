...
<section class="container">
    ...
    <div class="deposito">        
        ...
        <div class="progress-response">
            <table class="tabela" style="border: 0;">
                <thead>
                    <tr>
                        <th>Data</th>
                        <th>Valor</th>
                ...
                <tbody>
                    <tr>
                        <td style="border: 0;">25/07/2024</td>
                        <td style="border: 0;">200,00 MZN</td>
                        <td style="border: 0;">Aguardando</td>
                    </tr>
                </tbody>
            </table>
            ...
            <p class="wait">Aguardando...</p>
            <p class="">Verifique seu dispositivo e digite seu pin para confirmação a finalização  o deposito com sucesso.</p>
        </div>
    </div>
    <br>
    <div class="deposito">        
        <div class="table-header" style="display: flex; flex-direction: column;">
            <p>Depósito finalizado</p>
        </div>
        <div class="progress-response">
            <i class="bx bx-check-circle"></i>
            <p class="wait">Concluído com sucesso</p>
        </div>
    </div>
    ...
    <div class="deposito">        
        ...
        <div class="progress-response">
            <i class="bx bx-x close-icon error"></i>
            <p class="wait error">Falha no deposito</p>
        </div>
    </div>
</section>
<!--fim do main-->
